...
void LCD_WR_REG(uint16_t LCD_Reg) {
	...
	GPIO_SetBits(GPIOC, GPIO_Pin_6); // CS low
	GPIO_SetBits(GPIOD, GPIO_Pin_13); // RS low
...
void LCD_WR_DATA(uint16_t LCD_Data) {
	//肄붾뱶�묒꽦
	GPIO_ResetBits(GPIOC, GPIO_Pin_6); // CS low
	GPIO_SetBits(GPIOD, GPIO_Pin_13); // RS high for data
	GPIO_SetBits(GPIOD, GPIO_Pin_15); // RD high
	GPIO_ResetBits(GPIOD, GPIO_Pin_14); // WR low
...
uint16_t LCD_ReadReg(uint16_t LCD_Reg) {
	...
	GPIO_SetBits(GPIOD, GPIO_Pin_14); // WR high
	GPIO_ResetBits(GPIOC, GPIO_Pin_6); // CS low
	GPIO_ResetBits(GPIOD, GPIO_Pin_15); // RD low
